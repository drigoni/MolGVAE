...
class MolGVAE(ChemModel):
    ...
    def default_params(cls):
        ...
        params.update({
                        ...
                        'train_file': 'data_esp7/molecules_train_%s.json' % dataset,
                        'valid_file': 'data_esp7/molecules_valid_%s.json' % dataset,
                        'test_file': 'data_esp7/molecules_test_%s.json' % dataset,
